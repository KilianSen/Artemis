...
public final class MathNodes {
     ...
     * Used by the EQUATION-mode grader to decide when a math is complete.
     *
     ...
     * <p>
     * Used exclusively for equality comparisons in the grader when {@code MathExercise.acNormalization} is set.
