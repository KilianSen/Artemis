...
import { MathExpressionCanvasComponent } from '../../../shared/expression-canvas/math-expression-canvas.component';
import { MathNodeContext } from '../math-math-node/math-math-node.component';
...
export class MathDerivationWorkspaceComponent implements OnInit {
